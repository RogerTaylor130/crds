...
type WebappLister interface {
	...
	List(selector labels.Selector) (ret []*webappv1alpha1.Webapp, err error)
...
type webappLister struct {
	listers.ResourceIndexer[*webappv1alpha1.Webapp]
}

// NewWebappLister returns a new WebappLister.
func NewWebappLister(indexer cache.Indexer) WebappLister {
	return &webappLister{listers.New[*webappv1alpha1.Webapp](indexer, webappv1alpha1.Resource("webapp"))}
}

// Webapps returns an object that can list and get Webapps.
func (s *webappLister) Webapps(namespace string) WebappNamespaceLister {
	return webappNamespaceLister{listers.NewNamespaced[*webappv1alpha1.Webapp](s.ResourceIndexer, namespace)}
}
...
type WebappNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*webappv1alpha1.Webapp, error)
