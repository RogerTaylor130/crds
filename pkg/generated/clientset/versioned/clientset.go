...
import (
	...
	rogerv1 "crds/pkg/generated/clientset/versioned/typed/webapp/v1"
	fmt "fmt"
	http "net/http"
...
type Interface interface {
	...
	RogerV1() rogerv1.RogerV1Interface
}
...
// RogerV1 retrieves the RogerV1Client
func (c *Clientset) RogerV1() rogerv1.RogerV1Interface {
	return c.rogerV1
}
...
func NewForConfigAndClient(c *rest.Config, httpClient *http.Client) (*Clientset, error) {
	...
	cs.rogerV1, err = rogerv1.NewForConfigAndClient(&configShallowCopy, httpClient)
	if err != nil {
		return nil, err
	}
