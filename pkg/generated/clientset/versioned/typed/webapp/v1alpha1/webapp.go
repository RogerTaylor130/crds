...
type webapps struct {
	*gentype.ClientWithList[*v1alpha1.Webapp, *v1alpha1.WebappList]
}

// newWebapps returns a Webapps
func newWebapps(c *WebappV1alpha1Client, namespace string) *webapps {
	return &webapps{
		gentype.NewClientWithList[*v1alpha1.Webapp, *v1alpha1.WebappList](
			"webapps",
			c.RESTClient(),
